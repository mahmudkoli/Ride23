...
2) Create and install an https certificate:
    ...
    ```
    dotnet dev-certs https -ep $env:USERPROFILE\.aspnet\https\Ride23.pfx -p 123456Aa!
    ```
...
from the root project folder and if everything builds fine, api should be available
